    ...
    class Grid {
        ...
        calculateSize() {
            ...
            this.columns = /*this.itemsTotal/*/ getComputedStyle(this.DOM.grid).getPropertyValue('--cell-number');
                console.log("calculateSize, columns="+this.columns);
            // The animejs stagger function needs an array [cols,rows]
            var rows = this.itemsTotal/this.columns;
                console.log("calculateSize, rows="+rows);
            this.gridDef = [this.columns, rows];
        }
        initEvents() {
            // Window resize event 
            ...
            window.addEventListener('resize', () => {
                ...
                this.calculateSize();
                this.columns = /*this.itemsTotal/*/ getComputedStyle(this.DOM.grid).getPropertyValue('--cell-number');
                    console.log("initEvents, columns="+this.columns);
